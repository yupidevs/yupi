 ...
 * You can ask questions and join the development discussion on our `Telegram group <https://t.me/yupidevs>`_.
...
You can use the options provided in `Support`_ to suggest new features you want to see in new releases of yupi.
